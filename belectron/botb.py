...
print ("Welcome, Created By Mamad BeLectron")

print ("Please Subscribe To The Channel To Receive Updates : @Belectron_bot")
				...
				if msg["type"]=="Text" and not msg.get("message_id") in answered:
					if not sleeped:
						if hasAds(msg.get("text")) and not msg.get("author_object_guid") in admins :
							...
							try:
								bot.sendMessage(target, "سازنده : حضرت آقا محمد بلکترون\n@seyed_xxx", message_id=msg.get("message_id"))
							except:
								print("err admin")
